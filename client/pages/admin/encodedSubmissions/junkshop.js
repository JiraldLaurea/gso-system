...
function junkshop() {
    ...
    const { data: barangaysEncode } = useSWR(
        "http://localhost:3001/junkshop/getAllJunkshop"
    );
    ...
    const view = async (e) => {
        ...
        await Axios.post(
            "http://localhost:3001/junkshop/getJunkshop",
            data
        ).then((res) => {
            setJunkshopName(res.data.junkshopName);
            setImageUrl(res.data.junkshopUrl);
        });
    };
        ...
        <div className="flex flex-col w-full">
            <div className="p-4 md:p-8">
                <div className="flex items-center mb-8">
                    ...
                    />
                    <h2 className="text-xl font-medium ">View junkshop</h2>
                </div>
